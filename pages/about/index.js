    ...
    <main>
        ...
        <article className={styles.hero}>
          <Col>
            <div className={styles.heroText}>
              <h3>
                Dedicated teams to help you <br /> meet and surpass your expectations.
              </h3>
      ...
      <section className={styles.section1}>
        <div className="col-md-6">
          ...
          <p>
            Organizations and Businesses today rely on technology to enhance and bring about the needed change in their
            business processes.
          </p>
          <p>
            At RodNorth we see technology as an enabler, that helps to drive this change in business processes, thus we
            use state of the art technology solutions that will help drive and improve business processes.
          </p>
          <p>
      ...
      <section className={styles.section2}>
        ...
        <Col md="6" className={styles.vision}>
          ...
          <div className="para">
            <h4>Our Values</h4>
            <p>Honesty .Teamwork .Customer centric .Integrity</p>
          </div>
        </Col>
      </section>
      <GetInTouch />
